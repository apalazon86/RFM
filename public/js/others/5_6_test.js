(function(){
  /*Primer algoritmo de filtrado y recomendacion de recetas
  ...
  */
  ...
  /*Segundo algoritmo de filtrado y recomendacion de recetas
    recipes: array de objetos de receta
    products: array de objetos producto
  */
  ...
  //Funcion para formatear la coleccion de recetas o productos
  function formatRecProd(collection){
    var text="";

    if (!collection.length) return text;
  ...
  },
  {
      ...
      "name": "Alubias blancas con almejas",
      "type": "Legumbres",
  ...
  {
      "_id": "39e477ee0ed32815",
      "name": "Tartar de salpicón de marisco",
      "type": "Mariscos",
      "instructions": "Cortamos el pulpo, las colas de langostinos, las verduras y las frutas y verduras en pequeños dados. Mezclamos todos los ingredientes y aliñamos con vinagre, aceite y sal al gusto. Servimos frío.",
      "photo": "Tartar marisco",
      "cGluten": false,
      "cMilk": false,
      "cSoy": false,
      "cEgg": false,
  ...
  console.log("------------------PASO 1------------------");
  console.log("Productos disponibles: "+formatRecProd(productsCollection));
  console.log("Recomendación Algoritmo 1: "+formatRecProd(getRecRecipes(recipeCollection,productsCollection)));
  console.log("Recomendación Algoritmo 2: "+formatRecProd(getRecRecipes2(recipeCollection,productsCollection)));
  console.log("------------------PASO 2------------------");
  productsCollection.push({"name":"Patatas","foodId":"11362"});
  productsCollection.push({"name":"Leche","foodId":"01109"});
  console.log("Productos disponibles: "+formatRecProd(productsCollection));
  console.log("Recomendación Algoritmo 1: "+formatRecProd(getRecRecipes(recipeCollection,productsCollection)));
  console.log("Recomendación Algoritmo 2: "+formatRecProd(getRecRecipes2(recipeCollection,productsCollection)));
  console.log("------------------PASO 3------------------");
  productsCollection.push({"name":"Sal","foodId":"02047"});
  productsCollection.push({"name":"Pimienta Negra","foodId":"02030"});
  console.log("Productos disponibles: "+formatRecProd(productsCollection));
  console.log("Recomendación Algoritmo 1: "+formatRecProd(getRecRecipes(recipeCollection,productsCollection)));
  console.log("Recomendación Algoritmo 2: "+formatRecProd(getRecRecipes2(recipeCollection,productsCollection)));
  console.log("------------------PASO 4------------------");
  productsCollection.push({"name":"Huevos","foodId":"01123"});
  console.log("Productos disponibles: "+formatRecProd(productsCollection));
  console.log("Recomendación Algoritmo 1: "+formatRecProd(getRecRecipes(recipeCollection,productsCollection)));
  console.log("Recomendación Algoritmo 2: "+formatRecProd(getRecRecipes2(recipeCollection,productsCollection)));
  console.log("------------------PASO 5------------------");
  productsCollection.push({"name":"Aceite de Oliva","foodId":"04053"});
  productsCollection.push({"name":"Cebollas","foodId":"11282"});
  console.log("Productos disponibles: "+formatRecProd(productsCollection));
  console.log("Recomendación Algoritmo 1: "+formatRecProd(getRecRecipes(recipeCollection,productsCollection)));
  console.log("Recomendación Algoritmo 2: "+formatRecProd(getRecRecipes2(recipeCollection,productsCollection)));
  console.log("------------------PASO 6------------------");
  productsCollection.push({"name":"Arroz","foodId":"20044"});
  console.log("Productos disponibles: "+formatRecProd(productsCollection));
  console.log("Recomendación Algoritmo 1: "+formatRecProd(getRecRecipes(recipeCollection,productsCollection)));
  console.log("Recomendación Algoritmo 2: "+formatRecProd(getRecRecipes2(recipeCollection,productsCollection)));
  console.log("------------------PASO 7------------------");
  productsCollection.push({"name":"Tomates","foodId":"11695"});
  productsCollection.push({"name":"Berenjenas","foodId":"11209"});
  console.log("Productos disponibles: "+formatRecProd(productsCollection));
  console.log("Recomendación Algoritmo 1: "+formatRecProd(getRecRecipes(recipeCollection,productsCollection)));
  console.log("Recomendación Algoritmo 2: "+formatRecProd(getRecRecipes2(recipeCollection,productsCollection)));
  console.log("------------------PASO 8------------------");
  productsCollection.push({"name":"Muslos de Pollo","foodId":"05091"});
  console.log("Productos disponibles: "+formatRecProd(productsCollection));
  console.log("Recomendación Algoritmo 1: "+formatRecProd(getRecRecipes(recipeCollection,productsCollection)));
  console.log("Recomendación Algoritmo 2: "+formatRecProd(getRecRecipes2(recipeCollection,productsCollection)));
  console.log("------------------PASO 9------------------");
  productsCollection.push({"name":"Atún","foodId":"15117"});
  console.log("Productos disponibles: "+formatRecProd(productsCollection));
  console.log("Recomendación Algoritmo 1: "+formatRecProd(getRecRecipes(recipeCollection,productsCollection)));
  console.log("Recomendación Algoritmo 2: "+formatRecProd(getRecRecipes2(recipeCollection,productsCollection)));
  console.log("------------------PASO 10------------------");
  productsCollection.push({"name":"Pulpo","foodId":"15166"});
  productsCollection.push({"name":"Queso Feta","foodId":"01019"});
  console.log("Productos disponibles: "+formatRecProd(productsCollection));
  console.log("Recomendación Algoritmo 1: "+formatRecProd(getRecRecipes(recipeCollection,productsCollection)));
  console.log("Recomendación Algoritmo 2: "+formatRecProd(getRecRecipes2(recipeCollection,productsCollection)));
